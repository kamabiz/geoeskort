...
export function SocialLoginButtons({ label = 'ან გაიარე:' }: Props) {
  return (
    <div className="social-login">
      <p className="social-login__divider">{label}</p>
      <div className="social-login__buttons">
        <a href="/api/auth/google" className="social-login__btn social-login__btn--google">
        ...
        <a href="/api/auth/facebook" className="social-login__btn social-login__btn--facebook">
