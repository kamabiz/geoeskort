  ...
  return (
    <div className="hero__stats-deck hero__stats-deck--desktop" aria-label="Community stats">
      <div className="hero__stats hero__stats--desktop hero__stats--deck" role="list">
        <article className="hero__stat-card" role="listitem" data-stat="stories">
        ...
        <article className="hero__stat-card hero__stat-card--live" role="listitem" data-stat="online">
          <span className="hero__stat-card-icon" aria-hidden>●</span>
          <span className="hero__stat-card-body">
        ...
        <article className="hero__stat-card" role="listitem" data-stat="members">
          <span className="hero__stat-card-icon" aria-hidden>👥</span>
          <span className="hero__stat-card-body">
        ...
        <article className="hero__stat-card" role="listitem" data-stat="comments">
          <span className="hero__stat-card-icon" aria-hidden>💬</span>
          <span className="hero__stat-card-body">
